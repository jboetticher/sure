class Transaction < ApplicationRecord
  ...
  # Local fork change (2026-08-16): added `investment_contribution` so
  # contributions to Jeremy's own investment accounts (Vanguard/Fidelity/etc.)
  # do not count as expenses in the outflows donut or income statement — they're
  # transfers between his own accounts. `loan_payment` (mortgage) intentionally
  # stayed IN as real cash outflow.
